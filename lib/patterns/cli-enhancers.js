 ...
 *
 * Supported languages: javascript, typescript, python, rust, go, shell, c, cpp
 *
 ...
 */
const SUPPORTED_LANGUAGES = ['javascript', 'typescript', 'python', 'rust', 'go', 'shell', 'c', 'cpp'];
...
const CLI_TOOLS = {
  ...
  jscpd: {
    ...
    languages: ['javascript', 'typescript', 'python', 'go', 'rust', 'c', 'cpp']
  },
