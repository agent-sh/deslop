...
const slopPatterns = {
   ...
   */
  c_placeholder_todo: {
    pattern: /\bassert\s*\(\s*(?:false|0)\s*&&\s*["'].*(?:not\s+impl|TODO|implement)/i,
    exclude: ['*_test.c', '*_test.cpp', '**/tests/**', '**/test/**'],
    severity: 'high',
    autoFix: 'flag',
    language: 'c',
  ...
  cpp_throw_not_implemented: {
    pattern: /\bthrow\s+(?:std::)?(?:runtime_error|logic_error|domain_error)\s*\(\s*["'].*(?:not\s+impl|TODO|implement)/i,
