...
const slopPatterns = {
  ...
  rust_log_debug: {
    ...
    autoFix: 'remove',
    language: 'rust',
    description: 'debug/trace logging left in production code (log or tracing crate)'
  },
  ...
  rust_expect_production: {
    ...
    autoFix: 'flag',
    language: 'rust',
    description: '.expect() can panic in production - prefer ? operator or error handling'
  },
