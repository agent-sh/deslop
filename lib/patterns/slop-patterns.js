...
const slopPatterns = {
  ...
  java_sysout_debugging: {
    ...
    autoFix: 'remove',
    language: 'java',
    description: 'Java System.out/err.println() debug output in production code'
  },
  ...
  java_suppress_warnings: {
    pattern: /@SuppressWarnings\s*\(\s*["'](?:unchecked|rawtypes|all|deprecation)["']/,
    exclude: ['*Test.java', '**/test/**', '**/tests/**'],
    severity: 'low',
    autoFix: 'flag',
    language: 'java',
   ...
   */
  java_raw_type: {
    pattern: /\b(?:List|Map|Set|Collection|Iterable|Iterator|Queue|Deque)\s+\w+\s*[=;]/,
    exclude: ['*Test.java', '**/test/**', '**/tests/**'],
    severity: 'low',
    autoFix: 'flag',
    language: 'java',
  ...
  kotlin_println_debugging: {
    ...
    autoFix: 'remove',
    language: 'kotlin',
    description: 'Kotlin println() debug output in production code'
  },
  ...
  kotlin_swallowed_error: {
    pattern: /runCatching\s*\{[^}]*\}\s*\.\s*getOrNull\s*\(\s*\)/,
    exclude: ['*Test.kt', '**/test/**', '**/tests/**'],
    severity: 'medium',
    autoFix: 'flag',
    language: 'kotlin',
    description: 'Kotlin runCatching{}.getOrNull() - silently swallows errors'
  },
  ...
  kotlin_suppress_annotation: {
    pattern: /@Suppress\s*\(\s*["'](?:UNCHECKED_CAST|DEPRECATION|unused)["']/,
    exclude: ['*Test.kt', '**/test/**', '**/tests/**'],
    severity: 'low',
    autoFix: 'flag',
    language: 'kotlin',
