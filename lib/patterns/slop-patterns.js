...
const slopPatterns = {
  ...
  java_suppress_warnings: {
    pattern: /@SuppressWarnings\s*\(\s*["']/,
    exclude: ['*Test.java', '**/test/**', '**/tests/**'],
    severity: 'low',
    autoFix: 'flag',
    language: 'java',
    description: 'Java @SuppressWarnings - review if suppression is justified'
  },
   ...
   */
  java_raw_type: {
    pattern: /(?:List|Map|Set|Collection|Iterable|Iterator|Queue|Deque)\s+\w+\s*[=;]/,
    exclude: ['*Test.java', '**/test/**', '**/tests/**'],
    severity: 'low',
    autoFix: 'flag',
    language: 'java',
  ...
  kotlin_println_debugging: {
    pattern: /(?<!\w)println\s*\(/,
    exclude: ['*Test.kt', '**/test/**', '**/tests/**', '**/examples/**', '**/demo/**', 'main.kt', 'Main.kt'],
    severity: 'medium',
    autoFix: 'remove',
    language: 'kotlin',
  ...
  kotlin_suppress_annotation: {
    pattern: /@Suppress\s*\(\s*["']/,
    exclude: ['*Test.kt', '**/test/**', '**/tests/**'],
    severity: 'low',
    autoFix: 'flag',
    language: 'kotlin',
    description: 'Kotlin @Suppress annotation - review if suppression is justified'
  },
